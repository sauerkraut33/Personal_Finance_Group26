...
# ----------------------------
# Load CSV (FSI.py under visualization/)
# ----------------------------
...
def scatter_with_regression(x, y, x_label, y_label="FSI", y_cap=None):
...
# enforce FSI cap
df = df[df[Y_COL] <= FSI_CAP]

# ----------------------------
# Make 2 graphs
# ----------------------------
for x_col, x_label in X_COLS:
    scatter_with_regression(df[x_col], df[Y_COL], x_label=x_label, y_label="FSI", y_cap=FSI_CAP)
